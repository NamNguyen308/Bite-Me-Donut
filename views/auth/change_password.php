 ...
 * Flow: verify current password via /api/auth/login, then update via /api/users/me (or dedicated endpoint)
 * Note: No OTP required for password change — current password verification is sufficient.
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="stylesheet" href="../../public/assets/css/change_password.css" />
</head>
<body>
  ...
  <div class="profile-layout">
    ...
    <aside class="profile-sidebar" id="profileSidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="../../views/auth/change_password.php" class="sidebar-nav__item active" data-page="change-password">
          <span class="sidebar-nav__icon">
        ...
        <div class="cp-card">
          ...
          <div class="cp-form" id="cpForm">
            ...
            <div class="form-group">
              ...
              <div class="cp-input-wrap">
                ...
                <button type="button" class="cp-toggle-btn" data-target="currentPassword" aria-label="Toggle visibility">
                  ...
                  <!-- eye-off icon -->
                  <svg class="icon-eye-off hidden" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                </button>
              </div>
            ...
            <div class="cp-actions">
              <button class="btn btn--primary btn--lg cp-submit-btn" id="submitBtn">
              ...
              <a href="../../views/user/profile.php" class="btn btn--ghost btn--lg">Cancel</a>
            </div>
          ...
          <div class="cp-success hidden" id="cpSuccess">
            ...
            <p class="cp-success__desc">Your password has been changed successfully. You'll be redirected to your profile in a moment.</p>
            <a href="../../views/user/profile.php" class="btn btn--primary">Back to Profile</a>
          </div>
